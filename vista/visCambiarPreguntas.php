	                ...
	                <div class="panel-body">
	                	<form name="form" action="" method="POST" class="form-horizontal" role="form">
		                    ...
		                    <div class="form-group" >
			                    ...
			                    <div class="col-sm-3" >		                        	
			                        <input type="pass" autocomplete="off"class="form-control"  name="contrasena" value="">		                      	                        	
			                    </div>
			                </div>
			                <div class="form-group" >
			                ...
			                <div class="form-group" >
			                    ...
			                    <div class="col-sm-3" >		                        	
			                        <input type="text" autocomplete="off"class="form-control"  name="respuesta1" value="">		                      	                        	
			                    </div>
			                </div>
			                <div class="form-group" >
			                ...
			                <div class="form-group" >
			                    ...
			                    <div class="col-sm-3" >		                        	
			                        <input type="text" autocomplete="off"class="form-control"  name="respuesta2" value="">		                      	                        	
			                    </div>
			                </div>
		                    ...
		                    <hr>
		                        <div class="col-sm-12">
		                            <input type="submit" class="btn btn-default col-sm-offset-4" name="aceptarpreguntas"  value="Aceptar">
		                            <input type="submit" class="btn btn-default" name="btnCancelarPreguntas"  value="Cancelar">
