...
include_once("../controlador/conModelo.php");
session_start();
...
$('#divnombre').show();
    ...
    loadDoc("q="+n,"BusMod.php",function(){
...
var todo={"modelo":cod};
      console.log(todo);
      $.post('../controlador/conModelo.php', {validamodelo: todo}, function(data) {
        ...
        if(datos[1]=="si"){
          ...
          document.form.cos_mod.value=datos[3];
			...
			<div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form name="form" action="" method="POST" class="form-horizontal" role="form">
                          ...
                          <div class="col-sm-3" >
                              <input type="text" class="form-control" id="pre_Modelo" name="cos_mod" value="<?php echo $arreglo_buscar["cos_mod"];?>">
                          </div>
