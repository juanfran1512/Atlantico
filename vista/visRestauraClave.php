...
<header class="cabecera">
				<img class="cabecera-img" src="../default/imagenes/cintilloultrarevolucionarioXD.png" />
			</header>
			...
			<div class="panel panel-default">
	                ...
	                <div class="panel-body">
	                	<form name="form" action="" method="POST" class="form-horizontal" role="form">
	                		<input type="hidden" autocomplete="off"class="form-control"  name="cedula" value="<?php echo ($ced) ?>">
		                    ...
		                    <hr>
		                        <div class="col-sm-12">
		                            <input type="submit" class="btn btn-default col-sm-offset-4" name="aceptarrestaura"  value="Aceptar">
		                            <input type="submit" class="btn btn-default" name="btnCancelarRestaura"  value="Cancelar">
		                        </div>
		                </form>
	           		</div>
	        </div>
