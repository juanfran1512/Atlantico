...
include_once("../controlador/conTipoTela.php");
session_start();
...
$('#divnombre').show();
    ...
    loadDoc("q="+n,"BusTipoTel.php",function(){
...
var todo={"tela":cod};
      console.log(todo);
      $.post('../controlador/conTipoTela.php', {validatipotela: todo}, function(data) {
        ...
        if(datos[1]=="si"){
          ...
          document.form.pre_tipo_tela.value=datos[3];
          document.form.can_uso_tela.value=datos[5];
          document.form.ope_tela.value=datos[6];
        ...
        if(datos[1]=="no"){
          alert("No existe ese Tipo de Tela");
        }
        console.log(datos);
      });
	                	...
	                	<form name="form" action="" method="POST" class="form-horizontal" role="form">
		                    ...
		                    <div class="form-group">
		                        ...
		                        <div class="col-sm-3" >
		                        	...
		                        	<input type="text" class="form-control"  autocomplete="off" id="nombre" onkeyup="busqueda()" onblur="this.value=this.value.toUpperCase()"name="nombre" value="<?php echo $arreglo_buscar["nom_tipo_tela"];?>">
		                        	<div id="divnombre"></div>
		                            	<input type="hidden" class="form-control" autocomplete="off" name="codigo" value="<?php echo $arreglo_buscar["cod_tipo_tela"];?>">
		                           		<!-- boton buscar-->
                          ...
                          <div class="col-sm-3" >
                              <input type="text" class="form-control" id="pre_tipo_tela" name="pre_tipo_tela" value="<?php echo $arreglo_buscar["pre_tipo_tela"];?>">
                          </div>

			                </div>
                      <br>
                      <h5 align="center">Avanzado si desconoce su funcion por favor no modificar</h5>
                      <br>
                      <div class="form-group">
                         <label class="col-sm-2  control-label">* Piezas</label>
                          <div class="col-sm-3" >
                              <input type="text" class="form-control" id="can_uso_tela" placeholder="1.5 o 4"title="Se coloca la cantidad de piezas que rinde ya sea por metro o por kilo"name="can_uso_tela" value="<?php echo $arreglo_buscar["can_uso_tela"];?>">
                          </div>
                           <label class="col-sm-2  control-label">* Operador</label>
                          <div class="col-sm-3" >
                              <input type="text" class="form-control" id="ope_tela" placeholder="/ o X" title="Si la tela la venden por kilo se usa signo de division y si es por metro el signo de multiplicar" name="ope_tela" value="<?php echo $arreglo_buscar["ope_tela"];?>">
                          </div>
                      </div>
